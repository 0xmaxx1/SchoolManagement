    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentsSubjects", x => new { x.DepartmentsId, x.SubjectsId });
                    table.ForeignKey(
                        name: "FK_DepartmentsSubjects_Departments_DepartmentsId",
                        column: x => x.DepartmentsId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartmentsSubjects_Subjects_SubjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentsSubjects_SubjectsId",
